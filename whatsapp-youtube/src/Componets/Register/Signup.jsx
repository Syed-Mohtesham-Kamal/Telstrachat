...
const Signup = () => {
  ...
  const handleSubmit = (e) => {
    ...
    if (full_name.length < 4 || !email.endsWith("@gmail.com")) {
    ...
    <div>
      ...
      >
        <Alert
          ...
          sx={{ width: "100%", backgroundColor: isSuccess ? green[600] : "red", color: "#fff" }} // Conditional color
        >
          {isSuccess ? "Authentication successful!" : "Authentication failed! Please check your input."}
        </Alert>
      </Snackbar>
      </div>
    </div>
